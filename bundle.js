...
/***/ function(module, exports, __webpack_require__) {
	...
	var Main = function (_Component) {
	  ...
	  _createClass(Main, [{
	    ...
	    value: function startSession() {
	      var sessionCanBeStarted = this.state.sessionCanBeStarted;
	    ...
	    key: 'handleTimerStop',
	    value: function handleTimerStop() {
	      this.stopSession();
	      this.resetSession();
	    }
	    ...
	    key: 'handleTimerReset',
	    value: function handleTimerReset() {
	          ...
	          _react2.default.createElement(
	            ...
	            function (seconds, percent) {
	              return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                  'wordCount',
	                  { className: _styles2.default.wordcount },
	                  (_this2.state.wordCount || 0) + ' of ' + _this2.state.wordCountGoal
	                ),
	                _react2.default.createElement(_editor2.default, { isDecayable: sessionCanBeStarted,
	                  ...
	                  wordCountGoal: _this2.state.wordCountGoal,
	                  onReachWordCount: _this2.stopSession.bind(_this2),
	                  onEdit: function onEdit(count) {
	                    return _this2.setState({ wordCount: count });
	                  } })
	              );
	            }
	          ),
	...
	_reactDom2.default.render(_react2.default.createElement(Main, null), document.getElementById('mainRoot'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var store = (0, _redux.applyMiddleware)(_reduxThunk2.default)(_redux.createStore)(app);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function editor() {
	  ...
	  switch (action.type) {
	    case _types2.default.SET_PASSAGE:
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Timer = function (_Component) {
	  ...
	  _createClass(Timer, [{
	    ...
	    key: 'toggleTimerIsOn',
	    value: function toggleTimerIsOn() {
	    ...
	    key: 'truncated',
	    value: function truncated(number) {
	    ...
	    value: function tick() {
	      ...
	      var secondsElapsed = this.truncated((Date.now() - this.startedAt) / 1000) + this.state.savedSeconds;
	      var percentDone = Math.ceil(secondsElapsed / duration * 100);
	      if (secondsElapsed >= this.props.duration) {
	        this.setState({ secondsElapsed: 0, percentDone: 100 });
	        this.stop();
	      } else {
	        this.setState({ secondsElapsed: secondsElapsed, percentDone: percentDone });
	      }
	    }
	  }, {
	    key: 'start',
	    ...
	    value: function render() {
	      var _state = this.state,
	          ...
	          percentDone = _state.percentDone;
	      var children = this.props.children;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Clock = function (_Component) {
	  ...
	  _createClass(Clock, [{
	    key: 'unitsFromSeconds',
	    value: function unitsFromSeconds(timeInSeconds) {
	      var total = Number(timeInSeconds);
	      return {
	    ...
	    key: 'render',
	    value: function render() {
	      var _unitsFromSeconds = this.unitsFromSeconds(this.props.seconds),
	          hours = _unitsFromSeconds.hours,
	          seconds = _unitsFromSeconds.seconds,
	          minutes = _unitsFromSeconds.minutes;

	      return _react2.default.createElement(
	        'div',
	        { className: _styles2.default.shotClock },
...
/***/ function(module, exports, __webpack_require__) {
	...
	// exports
	exports.locals = {
		"shotClock": "_3rd2dECFMKfJt2SXab7iHv"
	};
